...
var MooRainbow = new Class({
	...
	doLayout: function() {
		...
		var ov = new Element('img', {
			'styles': {'background-color': '#fff', 'position': 'relative', 'zIndex': 200},
			'src': this.options.imgPath + 'moor_woverlay.png',
			'class': prefix + 'overlay'
		}).inject(div);
		
		var ov2 = new Element('img', {
			'styles': {'position': 'absolute', 'top': 0, 'left': 0, 'zIndex': 200},
		...
		var cr = new Element('div', {
			'styles': {'overflow': 'hidden', 'position': 'absolute', 'zIndex': 200},
			'class': prefix + 'cursor'	
		}).inject(div);
		...
		var sl = new Element('img', {
			'styles': {'position': 'absolute', 'z-index': 200},
		...
		new Element('div', {
			'styles': {'zIndex': 200, 'position': 'absolute'},
			'class': prefix + 'chooseColor'
		}).inject(box);
			
		this.layout.backup = new Element('div', {
			'styles': {'zIndex': 200, 'position': 'absolute', 'cursor': 'pointer'},
