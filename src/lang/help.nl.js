IIPMooViewer.lang = {
	...
	'zoomOut': 'Shift toets ingedrukt houden en dubbelklikken met de muis of gebruik het muiswieltje (scrollen); u kunt ook "-" toets gebruiken',
	'rotate': 'Roteren met de klok mee: toets "r", tegen de klok in: druk op shift en "r"',
	'fullscreen': 'Volledig scherm: toets "f"',
	'annotations': 'Tonen/verbergen annotaties: toets "a"',
	'navigation': 'Tonen/verbergen navigatievenster: toets "h"',
	'more': 'Voor meer informatie bezoek',
